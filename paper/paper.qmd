...
```{r, fig.cap = "Total GDP Growth of all copuntries Over Time 1992-2022", tab.width=5, echo=FALSE}
#| warning: false
#| message: false

ggplot(countries_energy_GDP_data, aes(x = Year, y = Average_GDP_Growth)) +
  geom_point(color="orange") +
  labs(title = "Average GDP Growth Over Time for High Income Countries",
       x = "Year",
       y = "GDP Growth (%)",

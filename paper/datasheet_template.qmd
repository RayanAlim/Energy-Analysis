---
title: "Datasheet for Economic and Energy Consumption Trends: A Global Analysis"
subtitle: "An Integrated Dataset of GDP Growth and Per Capita Energy Use (1965-2022)"
author: 
  -Rayan Awad Alim
thanks: "Code and data are available at: https://github.com/RayanAlim/Energy-Analysis"
date: "`r Sys.time()`"
date-format: "D MMMM YYYY"
abstract: "This datasheet describes a dataset that integrates annual GDP growth data sourced from the World Bank and OECD National Accounts with per capita primary energy consumption figures obtained from the U.S. Energy Information Administration and the Energy Institute's Statistical Review of World Energy. Covering the period from 1965 to 2022, the dataset includes data for countries recognized by the UN during the years which the dataset covers. It was made to see the interplay between economic growth and energy us and was compiled and standardized to provide a reliable basis for econometric analysis, aiming to inform policy decisions and academic research in the fields of environmental economics and sustainable development."
format: pdf
